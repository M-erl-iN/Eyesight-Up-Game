...
class QuestTablet(pygame.sprite.Sprite):
    ...
    def draw_matrix(self, screen):
        for i in range(len(self.matrix)):
            ...
            screen.blit(options_images[1], (self.reward_image_x, y))
...
def set_first_blocked_level(level):
...
if __name__ == "__main__":
    ...
    #     screen.fill(BLACK)
    #     screen.blit(animated_background, back_rect)R
    #     pygame.display.flip()
